 ...
 *
 * 来源网址：https://www.cnblogs.com/shamo89/p/9774852.html
 */
public class ForkJoinTaskTest004 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Test004Task task1 = new Test004Task(array, 0, array.length);
...
class Test004Task extends RecursiveAction {
    ...
    // 4. 实现类的构造函数，初始化属性值。
    public Test004Task(int array[], int start, int end) {
        this.array = array;
        this.start = start;
        this.end = end;
    }
    ...
    protected void compute() {
        if (end - start > 100) {
            int mid = (start + end) / 2;
            Test004Task task1 = new Test004Task(array, start, mid);
            Test004Task task2 = new Test004Task(array, mid, end);
